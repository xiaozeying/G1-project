...
export INTERRUPT_AGENT_LOCAL_TEXT_BASE_URL="${INTERRUPT_AGENT_LOCAL_TEXT_BASE_URL:-http://127.0.0.1:11434}"
export INTERRUPT_AGENT_LOCAL_TEXT_MODEL="${INTERRUPT_AGENT_LOCAL_TEXT_MODEL:-qwen2.5:1.5b}"
