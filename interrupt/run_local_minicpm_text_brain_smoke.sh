...
export INTERRUPT_AGENT_LOCAL_TEXT_BASE_URL="${INTERRUPT_AGENT_LOCAL_TEXT_BASE_URL:-http://127.0.0.1:8000/v1}"
...
echo "===== $(date '+%F %T') run_local_minicpm_text_brain_smoke.sh ====="
