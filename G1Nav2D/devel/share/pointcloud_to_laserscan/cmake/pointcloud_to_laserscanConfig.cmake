...
if("TRUE" STREQUAL "TRUE")
  set(pointcloud_to_laserscan_SOURCE_PREFIX /root/HongTu/G1Nav2D/src/pointcloud_to_laserscan)
  set(pointcloud_to_laserscan_DEVEL_PREFIX /root/HongTu/G1Nav2D/devel)
  ...
  set(pointcloud_to_laserscan_INSTALL_PREFIX /root/HongTu/G1Nav2D/install)
...
if(NOT "/root/HongTu/G1Nav2D/src/pointcloud_to_laserscan/include " STREQUAL " ")
  set(pointcloud_to_laserscan_INCLUDE_DIRS "")
  set(_include_dirs "/root/HongTu/G1Nav2D/src/pointcloud_to_laserscan/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/HongTu/G1Nav2D/src/pointcloud_to_laserscan/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/HongTu/G1Nav2D/devel/lib;/root/HongTu/G1Nav2D/devel/lib;/opt/ros/noetic/lib)
