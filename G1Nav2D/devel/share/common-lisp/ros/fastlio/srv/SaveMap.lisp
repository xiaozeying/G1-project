...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fastlio-srv:<SaveMap-request> is deprecated: use fastlio-srv:SaveMap-request instead.")))

(cl:ensure-generic-function 'save_path-val :lambda-list '(m))
(cl:defmethod save_path-val ((m <SaveMap-request>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SaveMap-request>)))
  ...
  "2ecd66ba01bbd96308e3355e33bda01e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SaveMap-request)))
  "Returns md5sum for a message object of type 'SaveMap-request"
  "2ecd66ba01bbd96308e3355e33bda01e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SaveMap-request>)))
  ...
  (cl:format cl:nil "string save_path~%float32 resolution~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SaveMap-request)))
  "Returns full string definition for message of type 'SaveMap-request"
  (cl:format cl:nil "string save_path~%float32 resolution~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fastlio-srv:<SaveMap-response> is deprecated: use fastlio-srv:SaveMap-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <SaveMap-response>))
